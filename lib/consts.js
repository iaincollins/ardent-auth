...
const ARDENT_AUTH_BASE_URL = process.env?.ARDENT_AUTH_BASE_URL ?? 'https://auth.ardent-insight.com'
const ARDENT_WWW_BASE_URL = process.env?.ARDENT_WWW_BASE_URL ?? 'https://ardent-insight.com'
